...
function About() {
  ...
  const aboutItems = [
    {
      ...
      short: (
        <>
          ...
          <span className="font-semibold text-[#69213f]">Audit, Taxation & Consultancy</span>, always placing clients' interests first.{' '}
    ...
    },
    {
      ...
      short: (
        <>
          Founded on <span className="font-semibold text-[#69213f]">1st April 1986</span> by{' '}
          <span className="font-semibold text-[#69213f]">CA Uttam Chandra Asija</span>, we have grown over the past 39+ years into one of Lucknow’s most trusted and prominent Chartered Accountancy firms.{' '}
    ...
    },
    {
      ...
      short: (
        <>
          Spread across an expansive <span className="font-semibold text-[#69213f]">6,050 sq. ft.</span> — one of the largest CA offices in Lucknow — our fully air-conditioned head office is located in the prime commercial hub of the city with 100% power backup.{' '}
  ...
  return (
    <div
      className={`w-screen min-h-screen bg-[#fcece1] flex flex-col lg:flex-row ${inter.variable} font-sans`}
    >
      {/* ── LEFT SIDEBAR ── */}
      <aside className="w-full lg:w-[20%] border-b-2 lg:border-b-0 lg:border-r-2 border-zinc-400 py-10 text-[#69213f] flex flex-col">
        <div className="flex items-center gap-3">
          <div className="w-8 h-5 bg-[#69213f]" />
      ...
      {/* ── MAIN CONTENT ── */}
      <main className="w-full lg:w-[55%] px-6 lg:px-15 pt-20 lg:pt-40 pb-10 lg:pb-20 flex flex-col gap-10 text-[#262D33]">
        <section className="space-y-6">
          <p className="text-3xl lg:text-4xl font-semibold leading-tight">
            <span className="text-[#69213f]">Asija & Associates LLP</span>, Chartered Accountants was established on{' '}
            <span className="text-[#69213f]">1st April 1986</span> by our founder member{' '}
            <span className="text-[#69213f]">CA. Uttam Chandra Asija</span> with the aim of providing a wide range of Accounting and Financial services to clients in Government, Corporate & Private Sectors.
          </p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20 mb-12 mt-12">
          {aboutItems.map((item) => {
            ...
            return (
              ...
              >
                <h3 className="text-2xl font-bold text-[#69213f] mb-2">{item.title}</h3>
                ...
                <div className="flex items-center gap-1 mt-2 text-[#69213f] text-sm font-medium">
                  {isOpen ? (
                    <>
