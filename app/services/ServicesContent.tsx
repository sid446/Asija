        ...
        {selectedService && (
          <>
            ...
            <motion.div
              ...
              className={`fixed bottom-0 left-0 right-0 h-[100vh] z-50 overflow-hidden shadow-2xl border-t ${theme === 'light' ? 'bg-gradient-to-br from-gray-50 via-white to-gray-100 border-gray-300' : 'bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#0f0f0f] border-gray-800'}`}
